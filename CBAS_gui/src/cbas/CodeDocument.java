...
/**
 * 
 * Highlights BLisp syntax based on regex patterns found in the Lexer class. 
 * Also contains built in Undo/Redo support seperate and more effective than the
 * UndoManager found in javaz.swing.undo
 * 
...
public class CodeDocument extends DefaultStyledDocument implements CaretListener {
    ...
    public static final String NAME = "[\\w&&[^\\d]][^\\s\\(\\)]*";
    public static final String OPERATOR = "\\+|\\-|\\\\|\\*|\\&|\\^|\\~|\\!|\\>|\\<|\\=|\\?";
    public static final String STRING = "\"(?:[^\"\n\\\\]|\\\\.)*(?:\"|\n)";
    public static final String CHAR = "'(?:[^'\n\\\\]|\\\\.)*(?:'|\n)";
    public static final String FLOAT = "[\\+\\-]?\\d+(?:\\.\\d*)"; 
    public static final String INTEGER = "[\\+\\-]?\\d+"; 
    public static final String TYPES = "\\b(?:int|long|bool|float|double|char|void|char)(?:\\b|\\*)";
    public static final String KEYWORDS = "\\b(?:virtual|new|delete|unsigned|extern|while|if|else|for|do|until|sizeof|return|break|case|switch|true|false|static|goto|const|typedef|struct|union|class|public|private|protected|using|namespace)\\b";
    /**
    ...
    public CodeDocument() {
        ...
        elemRegexes.put(Pattern.compile("[\\(\\)\\[\\]]"),Color.GREEN.darker());
        elemRegexes.put(Pattern.compile(INTEGER),Color.MAGENTA);
        elemRegexes.put(Pattern.compile(FLOAT),Color.MAGENTA);
        //elemRegexes.put(Pattern.compile(NAME),Color.BLACK);
        elemRegexes.put(Pattern.compile(OPERATOR),Color.RED);
        elemRegexes.put(Pattern.compile("#" + NAME), Color.GREEN.darker());
        elemRegexes.put(Pattern.compile(KEYWORDS), Color.BLUE);
        elemRegexes.put(Pattern.compile(TYPES), Color.BLUE);
        elemRegexes.put(Pattern.compile("&[^\\s\\(\\)]*+"),Color.RED);
        elemRegexes.put(Pattern.compile("\\<[^\\>]*\\>"),new Color(255,100,0));
        elemRegexes.put(Pattern.compile(STRING),new Color(255,100,0));
        elemRegexes.put(Pattern.compile(CHAR),new Color(255,100,0));
        elemRegexes.put(Pattern.compile(COMMENT), Color.GRAY);
