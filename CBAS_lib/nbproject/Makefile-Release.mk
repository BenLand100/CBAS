...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} dist/Release/MinGW-Windows/libCBAS_lib.dll

dist/Release/MinGW-Windows/libCBAS_lib.dll: ${OBJECTFILES}
	${MKDIR} -p dist/Release/MinGW-Windows
	${LINK.cc} -shared -o dist/Release/MinGW-Windows/libCBAS_lib.dll -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/libCBAS_lib.dll
